...
public class VehiculoController implements ActionListener {
    ...
    public void ListarVehiculos(JTable tabla) {
        ...
        for (int i = 0; i < lista.size(); i++) {
            ...
            if (lista.get(i).getId_tipo_vehiculo()==1) {
                ob[2] = "Bus de Transporte";
            }
            if (lista.get(i).getId_tipo_vehiculo()==2) {
                ob[2] = "Camion de Carga";
            }
            if (lista.get(i).getId_tipo_vehiculo()==3) {
                ob[2] = "Vehiculo del Personal";
            }
            if (lista.get(i).getId_tipo_vehiculo()==4) {
                ob[2] = "Vehiculo Particular";
            }
            if (lista.get(i).getId_tipo_vehiculo()==5) {
                ob[2] = "Otro Vehiculo";
            }
